  ...
  return (
    <div className="project-form-container">
      ...
      <form onSubmit={handleSubmit} className="project-form">
        ...
        <div className="form-group">
          <label htmlFor="requiredReviewersRules">Правила ревью (JSON, необязательно)</label>
          <textarea
            id="requiredReviewersRules"
            value={requiredReviewersRules}
            onChange={(e) => setRequiredReviewersRules(e.target.value)}
            placeholder='Например: [{"Role":"Admin","Count":2},{"Role":"Owner"}]'
            disabled={loading}
            rows={4}
          />
          <small>
            JSON массив с правилами ревью. Пример: [&#123;"Role":"Admin","Count":2&#125;,&#123;"Role":"Owner"&#125;]
          </small>
        </div>
