...
public class ProjectInvitationsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_project_invitations);
        ...
        invitationsApi.getProjectInvitations(projectId).enqueue(new Callback<List<InvitationResponse>>() {
            ...
            public void onResponse(@NonNull Call<List<InvitationResponse>> call,
                ...
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    Toast.makeText(ProjectInvitationsActivity.this,
    ...
    private void updateUI(List<InvitationResponse> invitations) {
        if (invitations.isEmpty()) {
            ...
            adapter = new ProjectInvitationAdapter(invitations, invitationsApi, projectId, this);
            adapter.setOnInvitationCanceledListener(() -> {
                // Обновляем список после отмены приглашения
                loadInvitations();
            });
