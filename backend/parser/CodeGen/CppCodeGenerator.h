...
public:
    ...
    void visit(UnaryOp &n) override {
        ...
        json["operand"] = captureExpr(*n.operand);
        currentJson = json;
    }
    ...
    void visit(BinaryOp &n) override {
        ...
        json["left"] = captureExpr(*n.left);
        json["right"] = captureExpr(*n.right);
        currentJson = json;
    }
    ...
    void visit(AssignStmt &s) override {
        ...
        json["value"] = captureExpr(*s.value);
        currentJson = json;
    }
    ...
    void visit(ExprStmt &s) override {
        nlohmann::json json;
        json["type"] = "exprStmt";
        json["expression"] = captureExpr(*s.expression);
        currentJson = json;
    }
    ...
    void visit(IfStmt &s) override {
        nlohmann::json json;
        json["type"] = "if";
        json["condition"] = captureExpr(*s.condition);
        json["then"] = captureStmt(*s.thenBranch);
